...
$(document).ready(function(){
    ...
    if  ( $('#rol_idx').val() == 1){ 
        ...
        $.post("../../controller/proyecto.php?op=total",function (data) {
            data = JSON.parse(data);
            $('#lbltotal').html(data.TOTAL);
        }); 
    
        $.post("../../controller/proyecto.php?op=totalabierto",function (data) {
            data = JSON.parse(data);
            $('#lbltotalabierto').html(data.TOTAL);
        });
    
        $.post("../../controller/proyecto.php?op=totalcerrado", function (data) {
            data = JSON.parse(data);
            $('#lbltotalcerrado').html(data.TOTAL);
        });

        $.post("../../controller/proyecto.php?op=grafico", function (data) {
            data = JSON.parse(data);
