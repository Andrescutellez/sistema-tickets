        ...
        <div class="modal-content">
            ...
            <form method="post" id="usuario_form">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="rol_id" name="rol_id">
                            <option value="1">Interventor</option>
                            <option value="2">Jefe implementaciones</option>
                        </select>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="action" id="guardarButton" value="add" class="btn btn-rounded btn-primary">Guardar</button>
                </div>
            </form>
        </div>
    </div>
